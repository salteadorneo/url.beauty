        ...
        <div class="${tw`grid max-w-screen-xl px-4 py-8 mx-auto gap-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12`}">
            <div class="${tw`mr-auto place-self-center lg:col-span-7`}">
                ...
                <div class="${tw`flex items-center gap-2`}">
                  ...
                  >
                      <svg width="18" height="18" viewBox="0 0 256 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                  ...
                  <p class="${tw`max-w-2xl font-light text-gray-300 text-xs`}">
                    Developed by <a href="https://url.beauty/rk4yu" target="_blank" class="${tw`underline`}">@salteadorneo</a> with <a href="https://url.beauty/bUrQi" target="_blank" class="${tw`underline`}">Deno</a> and <a href="https://url.beauty/cc68x" target="_blank" class="${tw`underline`}">Deno KV</a>.
                  </p>
                </div>
            </div>
    ...
    <section class="${tw`bg-gray-600 h-screen grid place-content-center`}">
        <div class="${tw`grid max-w-screen-xl px-4 py-8 mx-auto gap-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12`}">
            <div class="${tw`mr-auto place-self-center lg:col-span-7`}">
                ...
                <p class="${tw`max-w-2xl mb-8 font-light text-white`}">
